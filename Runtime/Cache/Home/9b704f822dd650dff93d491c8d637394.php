...
<a rel="nofollow" href="<?php echo C('DOMAIN');?>" class="img"> <img src="/Public/Home/images/login-3.jpg" width='400' height='300'></a>
	...
	<form class="form-horizontal" role="form" action="/index.php?s=/Home/User/register.html" method="post">
		...
		<p>合作网站账号登录：<a class="" href="/index.php?s=/Home/Addons/execute/_addons/SyncLogin/_controller/Base/_action/login/type/qq.html"><img src="/Public/Home/images/qq.png"></a>
